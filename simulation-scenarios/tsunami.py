...
map1 = Map(aoi, wind, num_of_obstacles, 10, uavs)
wavefront_map0 = wavefront((uav_end[0] // Parameters.cell_size, uav_end[1] // Parameters.cell_size), map0)
wavefront_map1 = wavefront((uav_end[0] // Parameters.cell_size, uav_end[1] // Parameters.cell_size), map1)
all_wavefront_map = [wavefront_map0, wavefront_map1]
wavefront_map = all_wavefront_map[0]
# print(wavefront_map)
uav_index = 0
