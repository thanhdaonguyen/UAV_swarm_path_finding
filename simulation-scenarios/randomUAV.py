...
drawer = Drawer("random", map_width_1, map_height_1, cell_size_1)                       # Khởi tạo đối tượng Drawer
...
while running:
    ...
    drawer.draw_all(map0, swarm, clusters_centers, map_width_1, map_height_1, cell_size_1, cell_radius_1)
